...
beautiful.init(theme_path .. "/" .. theme_name .. "/" .. theme_file)
...
awful.rules.rules = {
    ...
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-iface)' },
      properties = { tag = tags[1][1],
                     floating = true,
                     width = lg_iface_width,
                     height = lg_iface_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=0, y=0}) end },
      -- Google Chrome
    { rule = { class = 'Google-chrome', instance = 'Google-chrome (/tmp/google-chrome-ts)' },
      properties = { tag = tags[1][1],
                     floating = true,
    ...
    { rule = { class = 'Google-chrome', instance = 'Google-chrome (/tmp/google-chrome-lgS0)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[0], y=0}) end },
    { rule = { class = 'Google-chrome', instance = 'Google-chrome (/tmp/google-chrome-lgS1)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[1], y=0}) end },
    { rule = { class = 'Google-chrome', instance = 'Google-chrome (/tmp/google-chrome-lgS2)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[2], y=0}) end },
    { rule = { class = 'Google-chrome', instance = 'Google-chrome (/tmp/google-chrome-lgS3)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[3], y=0}) end },
      -- Chromium
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-ts)' },
      properties = { tag = tags[1][1],
                     floating = true,
                     width = 1920-lg_iface_width,
                     height = 1080+lg_toolbar_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=lg_iface_width, y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-lgS0)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[0], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-lgS1)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[1], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-lgS2)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[2], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'Chromium-browser (/tmp/chromium-browser-lgS3)' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[3], y=0}) end },
    ...
    { rule = { class = 'Googleearth-bin', instance = 'ge-lgS3' },
      ...
      -- WebGL Aquarium (XXX DEPRECATED XXX)
    ...
    { rule = { class = 'MPlayer', instance = 'MPlayerTour' },
      properties = { floating = true,
                     ontop = true,
                     border_width = 0 } },
    { rule = { class = 'Chromium-browser', instance = 'ts' },
      properties = { tag = tags[1][1],
                     floating = false,
                     border_width = 0 } },
    { rule = { class = 'Chromium-browser', instance = 'lgS0' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[0], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'lgS1' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[1], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'lgS2' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[2], y=0}) end },
    { rule = { class = 'Chromium-browser', instance = 'lgS3' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=mp_win_x[3], y=0}) end },
    ...
    { rule = { class = 'xiv-lgS0' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=ge_win_x[0], y=0}) end },
    { rule = { class = 'xiv-lgS1' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=ge_win_x[1], y=0}) end },
    { rule = { class = 'xiv-lgS2' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=ge_win_x[2], y=0}) end },
    { rule = { class = 'xiv-lgS3' },
      properties = { floating = true,
                     width = lg_screen_width,
                     height = lg_screen_height,
                     border_width = 0 }, callback = function(c) c:geometry({x=ge_win_x[3], y=0}) end },
